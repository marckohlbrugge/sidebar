...
ActiveRecord::Schema[8.1].define(version: 2026_04_16_210951) do
  ...
  create_table "transcript_events", force: :cascade do |t|
    ...
    t.boolean "speech_final", default: false, null: false
    t.integer "stream_session_id", null: false
    t.text "transcript"
    t.datetime "updated_at", null: false
    t.index ["stream_session_id", "received_at"], name: "index_transcript_events_on_stream_session_id_and_received_at"
    t.index ["stream_session_id"], name: "index_transcript_events_on_stream_session_id"
  end
  ...
  create_table "turns", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["stream_session_id", "finalized_at"], name: "index_turns_on_stream_session_id_and_finalized_at"
    t.index ["stream_session_id"], name: "index_turns_on_stream_session_id"
  end

  add_foreign_key "comments", "turns"
  add_foreign_key "gate_decisions", "turns"
